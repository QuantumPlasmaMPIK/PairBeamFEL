...
Patch::Patch( Params &params, SmileiMPI *, DomainDecomposition *domain_decomposition, unsigned int ipatch )
{
    ...
    //! store the global box size for independent patch-based spatial information usage
    std::copy(params.grid_length.begin(), params.grid_length.end(), back_inserter(global_grid_length));
