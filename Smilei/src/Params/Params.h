...
public:
    ...
    double N_r; // reference particle density

    double WeightNormalizationFactor; // to get meaningful weight values to be used as a scalar factor in the radiation deposition calculation
