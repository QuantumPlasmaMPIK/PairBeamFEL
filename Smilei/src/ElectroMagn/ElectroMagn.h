...
struct PrescribedField {
    ...
    bool use_profile = true; // python-interfaced user-defined profile is used as a default
    double frame_gamma;
...
public:
    ...
    virtual void applyPrescribedField( Field *, PrescribedField *, Patch *, double time) = 0 ;
