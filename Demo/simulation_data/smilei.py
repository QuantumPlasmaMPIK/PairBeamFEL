...
class RadiationDetector(SmileiSingleton):
    """Detactor(RaDiO) parameters"""
    pixel_positions_x = []
    pixel_positions_y = []
    pixel_positions_z = []
    detector_time_array = []
...
class PrescribedField(SmileiComponent):
    ...
    frame_gamma = None
    frame_velocity = None
    undulator_start_lab_frame = None
    undulator_end_lab_frame = None
    undulator_period = None
    B_peak = None
...
_test_mode = True
smilei_version='b3e7174-main'
smilei_mpi_size = 1
smilei_omp_threads = 8
...
simulation_particle_pusher = "boris"                                 # type of pusher (Boris, borisBTIS3, Vay, higueracary)
simulation_maxwell_solver = "Yee"                                    # options: "Yee", "Cowan", "Grassi", "Lehe", "Bouchard", "M4"
...
K = 1.4                                                                # undulator parameter
B_peak = K / (0.934 * (undulator_period * 1e-4))                     # undulator magnetic field in Tesla
E_peak = B_peak * c                                                  # # in V/m
bunch_energy = 51.4                                                  # initial bunch energy in MeV
bunch_gamma = bunch_energy / electron_mass_MeV                       # initial average lorentz factor for the beam
Q_electron_bunch   = -2.5 * 1 * pC                                   # Total charge of the electron bunch
beam_longitudinal_sigma = 10                                         # Beam longitudinal spatial sigma in um.
beam_transverse_sigma = 200                                          # Beam transverse/radial rms size (cylindrical symmetry) in um.
...
bunch_normalized_emittance = 2e-1                                     # initial beam normalized emittance (beam divergence X transverse beam size), same for both transverse planes (in um_rad) --> valid for electron & positron
prebunching_factor = 1e-4                                            # Pre-bunched value of the initialized beam
...
species_macroparticle_number = int(1e4)                              # number of macroparticles to be used to define a species within the beam
num_of_undulator_periods = 10                                       # number of periodic arrangements of dipole magnets with alternating polarity
problem_scale_sampling = 16                                          # number of cells in the lowest problem scale
CFL_multiplication_factor = 0.95                                     # CFL multiplication factor
box_longutidunal_beam_factor = 4.0                                     # simulation_box_x / beam_full_length_x
...
diagnostics_frequency = 10                                           # Diagnostics I/O frequency
...
Tsim = 1.5 * required_simulation_time                 # simulation time
...
detector_time_grid_cell_number = 1e5
