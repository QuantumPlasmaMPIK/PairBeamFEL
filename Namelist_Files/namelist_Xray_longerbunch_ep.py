...
Q_electron_bunch   = -83.5 * 1 * pC                                   # Total charge of the electron bunch
beam_longitudinal_sigma = 1.                                       # Beam longitudinal spatial sigma in um.
...
num_of_undulator_periods = 320                                       # number of periodic arrangements of dipole magnets with alternating polarity
...
simulation_time_fraction = 1.5                                        # default is 1.0, mult. factor of T_sim.
