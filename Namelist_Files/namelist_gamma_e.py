...
Q_electron_bunch   = -2500 * 1 * pC                                   # Total charge of the electron bunch
...
species_macroparticle_number = int(1.2e7)                              # number of macroparticles to be used to define a species within the beam
