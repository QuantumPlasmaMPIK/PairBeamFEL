...
num_of_undulator_periods = 400                                       # number of periodic arrangements of dipole magnets with alternating polarity
...
transverse_field_plane_front_index = int(np.searchsorted( np.linspace(0, Lx, int(Lx/dx + 1), dtype = "float64"), Lx/2. + 1 * reference_bunch_size, 'left'))
